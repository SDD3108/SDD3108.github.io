...
class Basket{
    ...
    noAccountOrEmpty(){
        ...
        if(this.currentUser && this.currentUser.nm){
            blocks.append(empty)
            empty.innerHTML = `
            <h2> корзина пуста </h2>
            `
...
buy.addEventListener('click',()=>{
    ...
    if(arr.length !== 0){
        basket.toBuy()
        window.location.href = '/main/buying/buying.html'
    }
    else{
...
accountBtn.addEventListener('click',()=>{
    ...
    if(user && user.nm){
        ...
        window.location.href = '/main/registration/registration.html'
    }
})
...
accountBtnLink.addEventListener('click',()=>{
    ...
    if(currentUser && currentUser.nm){
        window.location.href = '/main/account/account.html'
    }
    else{
